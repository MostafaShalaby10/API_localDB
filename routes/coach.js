...
router.get('/' , async (req , res)=>
{
    mongo.connect(url , (err , db)=>
    {
        ...
        var x = db.db(dbname)
        x.collection("coach").find({}).toArray((err , data)=>
        {
            if (err) throw err
            res.json(data)
        }) 
...
router.post('/' , async (req , res)=>
{
    mongo.connect(url , (err , db)=>
    {
        ...
        var x = db.db(dbname)
        x.collection("coach").insertOne(obj , (err , data)=>
        {
            if (err) throw err
 ...
 router.get('/:name' , async (req , res)=>
{
    mongo.connect(url , (err , db)=>
    {
        ...
        var x = db.db(dbname)
         x.collection("coach").findOne({ name : req.params.name},(err , data)=>
        {
            if (err) throw err
            res.json(data)
        })  
...
router.put('/:name' , async(req , res)=>
{
    mongo.connect(url , (err , db)=>
    {
        ...
        x.collection("coach").updateOne(old , obj , (err , data)=>
        {
            if(err) throw err 
...
router.delete('/:name' , async(req , res)=>
{
    mongo.connect(url , (err , db)=>
    {
        ...
        x.collection("coach").deleteOne(obj ,(err , data)=>
        {
            if(err) throw err 
